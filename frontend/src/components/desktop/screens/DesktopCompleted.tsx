    ...
    <div className="flex flex-col flex-1 justify-center py-6 px-4 sm:px-8 max-w-3xl mx-auto w-full">
      <div className="bg-white p-8 sm:p-10 rounded-3xl border border-slate-200/80 shadow-xs space-y-6">
        ...
        <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
          ...
          {/* 2026-08-25：見 CompletedScreen.tsx（mobile 版）同一段
              說明——terms_submit 不再卡著等背景複核結果，桌面版走到
              這個畫面時 verificationVerdict 幾乎都還是 'pending'，文案
              要誠實反映「還在核實」，不能預設已通過。*/}
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">
              {formData.verificationVerdict === 'review'
                ...
                : '感謝您的申請！我們已收到您的開戶資料，系統正在進行最後複核，審核結果將透過簡訊與 Email 第一時間通知您。'}
            </p>
          </div>
        </div>
